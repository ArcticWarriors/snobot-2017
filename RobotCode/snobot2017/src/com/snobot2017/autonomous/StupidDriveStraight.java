...
/**
 * Autonomous command that allows the robot to drive straight at a certain 
 * speed for a certain period of time and stops it at the end
 * 
 * @author Nora
 *
 */
public class StupidDriveStraight extends TimedCommand
{
    ...
    /**
     * This method is called when the time runs out when the time runs out
