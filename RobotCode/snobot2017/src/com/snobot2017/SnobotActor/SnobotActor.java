...
public class SnobotActor implements ISnobotActor
{
    ...
    private class SmoothControlParams
    {
        ...
        {
            this(aGoalX, aGoalY, 6);
        }
        SmoothControlParams(double aGoalX, double aGoalY, double aDb)
        {
            mGoalX = aGoalX;
            mGoalY = aGoalY;
            mDeadband = aDb; // inches
        }
    }
    ...
    public SnobotActor(IDriveTrain aDriveTrain, IPositioner aPositioner)
    {
        ...
        mInDeadbandHelper = new InDeadbandHelper(5);
    ...
    public void setGoToPositionSmoothlyGoal(double aX, double aY)
    {
        ...
        mSmoothControlParams = new SmoothControlParams(aX, aY, mSmoothControlParams.mDeadband);
...
//        double angleErrorSpeed = ((distanceError < tooCloseDistance) ? 0 : adjustedAngleError * turnKp);
...
//        double distanceComponent =distanceError * distanceKp;
//        double distanceComponent =angleErrorSpeed * distanceKp;
//        
...
//                + leftAdjustment_a + ", Ra: " + rightAdjustment_a);
      ...
      System.out.println("DE: " + distanceError + ", AE: " + angleError + ", L: " + leftSpeed + ", R: " + rightSpeed + ", " + mSmoothControlParams.mDeadband);
