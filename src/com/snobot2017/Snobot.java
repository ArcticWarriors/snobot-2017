...
import com.snobot2017.joystick.SnobotOperatorJoystick;
...
public class Snobot extends ASnobot
{
    ...
    public Snobot()
    {
        ...
        // Raw Joysticks
        Joystick mRawDriverJoystick = new Joystick(Properties2017.sDRIVER_JOYSTICK_PORT);
        // Joystick mRawDriverJoystick2 = new
        // Joystick(Properties2017.sDRIVER_JOYSTICK_PORT2);
        Joystick mRawOperatorJoystick = new Joystick(Properties2017.sOPERATOR_JOYSTICK_PORT);
        ...
        // Drive train
        if (Properties2017.sIS_REAL_ROBOT)
        {
        ...
        {
            Encoder leftDriveEncoder = new Encoder(Properties2017.sLEFT_DRIVE_ENCODER_PORT_A, Properties2017.sLEFT_DRIVE_ENCODER_PORT_B);
            Encoder rightDriveEncoder = new Encoder(Properties2017.sRIGHT_DRIVE_ENCODER_PORT_A, Properties2017.sRIGHT_DRIVE_ENCODER_PORT_B);
            Talon driveLeftMotor = new Talon(Properties2017.sDRIVER_LEFT_MOTOR_PORT);
            Talon driveRightMotor = new Talon(Properties2017.sDRIVER_RIGHT_MOTOR_PORT);
        ...
        // Scaling
        // Talon mScaleMoveMotor = new
        // Talon(Properties2017.sSCALE_MOVE_MOTOR_PORT);
        // Talon mScaleTiltMotor = new
        // Talon(Properties2017.sSCALE_TILT_MOTOR_PORT);
        // AnalogInput mScalePot = new
        // AnalogInput(Properties2017.sSCALE_POT_PORT);
        // AnalogInput mExtensionPot = new
        // AnalogInput(Properties2017.sEXTENSION_POT_PORT);
        // mScaling = new Scaling(mScaleMoveMotor, mScaleTiltMotor,
        // mOperatorJoystick, mLogger, mScalePot, mExtensionPot);
        // mSubsystems.add(mScaling);

        // Harvester
        // Talon mHarvesterPivotMotor = new
        // Talon(Properties2017.sHARVESTER_PIVOT_MOTOR_PORT);
        // Talon mHarvesterRollerMotor = new
        // Talon(Properties2017.sHARVESTER_ROLLER_MOTOR_PORT);
        // AnalogInput mHarvesterPot = new
        // AnalogInput(Properties2017.sHARVESTER_POT_PORT);
        // mHarvester = new Harvester(mHarvesterRollerMotor,
        // mHarvesterPivotMotor, mOperatorJoystick, mLogger, mHarvesterPot);
        // mSubsystems.add(mHarvester);

        // Camera
        // Relay mCameraRelay = new Relay(Properties2017.sLIGHT_RELAY);
        // Light mCameraLight = new Light(mCameraRelay, mLogger);
        // mSubsystems.add(mCameraLight);
        //
        // if (Properties2017.sENABLE_CAMERA.getValue())
        // {
        // System.out.println("Enabling camera");
        // AxisCamera mAxisCamera = new
        // AxisCamera(Properties2017.sCAMERA_HOST_IP.getValue());
        ...
        // Positioner
        // Gyro mGyro;
        // if (Properties2017.sUSE_SPI_GYRO)
        // {
        // mGyro = new ADXRS450_Gyro();
        // }
        // else
        // {
        // mGyro = new AnalogGyro(Properties2017.sGYRO_SENSOR_PORT);
        // }
        // if (Properties2017.sUSE_IMU_POSITIONER)
        // {
        ...
        // else
        // {
        // mSnobotPositioner = new SimplePositioner(mGyro, mDrivetrain,
        // mLogger);
        // }
